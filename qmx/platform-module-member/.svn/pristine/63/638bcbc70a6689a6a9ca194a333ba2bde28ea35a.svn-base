    ...
    <#--&nbsp;&nbsp;-->
        ...
        <div class="layui-inline">
            <div class="layui-input-inline" style=" width: 251px;">
                ...
                <button class="layui-btn layui-btn-primary" type="reset" onclick="location.href='recharge'" >重置</button>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button class="layui-btn layui-btn-normal" type="button" onclick="location.href='../add/recharge';" >新增</button>
            </div>
        </div>
    </div>
</form>
...
<#if page.records??>
    <#list page.records as dto>
        <tr>
            ...
            <td>
                <input type="button" onclick="location.href='../edit/recharge?id=${dto.id!?c}';"
...
<script type="text/javascript">
    function del(id) {
        var msg = "确定要删除吗？\n\n请确认！";
        layer.confirm(msg, {title: "充值多倍积分删除确认"}, function () {
            window.location.href = "../delete/recharge?id=" + id;
        })
    }
