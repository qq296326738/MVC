...
<form class="layui-form" id="inputForm" action="update" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <label><input id="sheng" name="levelLock" value="true" title="是" type="radio" <#if dto.levelLock==true>checked </#if>></label>
                <label><input id="jiang" name="levelLock" value="false" title="否" type="radio" <#if dto.levelLock==false>checked </#if>></label>
            </div>
        </div>
    </div>
    <div class="layui-form-item" id="jifen">
        <div class="layui-inline">
            <label class="layui-form-label">升级所需积分</label>
            <div class="layui-input-inline">
                <input id="integral" name="integral" value="${dto.integral!}" lay-verify="required|number" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    </div>
    <div id="shengji" class="layui-form-item" style="">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <#list lList as ls>
                    <option value="${ls.id}"
                            <#if dto.upgradeId?? && dto.upgradeId == ls.id>selected</#if>>${ls.name}</option>
                </#list>
                </select>
            </div>
        </div>
