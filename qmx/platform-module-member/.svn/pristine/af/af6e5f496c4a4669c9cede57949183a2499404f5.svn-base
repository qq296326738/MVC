...
<form class="layui-form" id="inputForm" action="save" method="post">
    ...
    <div id="GDczje" class="layui-form-item" style="display: none">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" id="amount" name="amount" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div id="QJczje" class="layui-form-item" style="">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" id="minAmount" name="minAmount" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label" style="text-align: left;">最大充值金额</label>
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" id="maxAmount" name="maxAmount" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div id="ZSjf" class="layui-form-item" style="">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" id="integralPoint" placeholder="充100得120元" name="moneyPoint" lay-verify="required"
    ...
    <div id="ZSje" class="layui-form-item" style="display: none">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" id="moneyPoint" placeholder="充100只需要98元" name="discountPoint" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" id="JFBL" placeholder="充100得100积分" name="integralPoint" lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    </div>
