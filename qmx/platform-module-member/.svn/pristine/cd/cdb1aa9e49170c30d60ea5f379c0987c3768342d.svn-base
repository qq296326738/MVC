...
function deleteBg(t){
	$(t).parents('.mws_row').html("<a class='mws_bg_box'>+</a>");
	var $browser = $("a.mws_bg_box");
	$browser.unbind("click");
	$browser.browserwebsite();
}
						...
						$browserList.find("img").bind("click", function() {
							...
							if (isDirectory == "true") {
								...
								if (settings.input != null) {
									...
									var img = "<div class='mws_bg_box'><input type='hidden' name='imagesurl' value='"+url+"'/><img src='"+url+"' name='picFile' style='width: 120px;height: 120px;'/><em class='mws_bg_delete' onclick='deleteBg(this);'></em></div>";
									$browserButton.html(img);
						...
						if ($.trim(text) != "") {
							...
							if (data.message.type == "success") {
								if (settings.input != null) {
									...
									var img = "<div class='mws_bg_box'><input type='hidden' name='imagesurl' value='"+data.url+"'/><img src='"+data.url+"' style='width: 120px;height: 120px;'/><em class='mws_bg_delete' onclick='deleteBg(this);'></em></div>";
									$browserButton.html(img);
