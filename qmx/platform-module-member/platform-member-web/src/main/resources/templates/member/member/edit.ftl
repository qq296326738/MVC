...
<form class="layui-form" id="inputForm" action="update" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="birthday" value="<#if dto.birthday??>${dto.birthday?date!}</#if>" name="birthday"
                       lay-verify="required"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="pastTime" value="<#if dto.pastTime??>${dto.pastTime?date!}</#if>" name="pastTime"
                       lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="postalCode" value="${dto.postalCode!}" <#--lay-verify="required"--> autocomplete="off"
                       class="layui-input">
            </div>
        </div>
