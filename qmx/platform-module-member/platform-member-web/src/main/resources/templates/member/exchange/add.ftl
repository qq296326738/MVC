    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 1000px">
            ...
            <div class="layui-input-inline" style="width: 500px">
                <label><input id="JF" type="radio" name="type" value="section" title="积分" checked/></label>
                <label><input id="JFJE" type="radio" name="type" value="fixed" title="积分+金额"/></label>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div id="DHJE" class="layui-inline" style="display: none">
            <label class="layui-form-label">兑换所需金额</label>
            <div class="layui-input-inline">
                <input name="money" value="0" lay-verify="number" autocomplete="off" class="layui-input">
            </div>
        </div>

        <div id="DHBL" class="layui-inline" style="display: none">
            <label class="layui-form-label">积分比例<span style="color: red">1:</span></label>
            <div class="layui-input-inline">
                <input name="integralProportion" value="0" lay-verify="number" autocomplete="off" class="layui-input">
            </div>
        </div>
