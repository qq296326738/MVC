...
if((filename == '/' || reg.test(filename)) && /AppleWebKit.*Mobile/i.test(navigator.userAgent) || (/MIDP|SymbianOS|NOKIA|SAMSUNG|LG|NEC|TCL|Alcatel|BIRD|DBTEL|Dopod|PHILIPS|HAIER|LENOVO|MOT-|Nokia|SonyEricsson|SIE-|Amoi|ZTE/.test(navigator.userAgent))){
	window.location.href="/adminwap/";
}
...
$().ready(function() {
	...
	if((filename != '' && filename != 'login.jsp') && top==self) {
