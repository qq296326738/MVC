...
<div class="layui-form-item">
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline" style="width: 130px">
            <button id="ShopBtn" class="layui-btn layui-btn-normal">会员初始化设置</button>
        </div>
        <div class="layui-input-inline">
            <button id="copy" data-clipboard-text="${url!}" class="btn layui-btn layui-btn-normal">复制链接</button>
        </div>
    </div>
...
<#list page.records as dto>
    <tr>
        ...
        <#--<span title="未命名" &lt;#&ndash;style="color: #ff5654"&ndash;&gt;>*****</span>-->
            (${dto.cardNo!"未设置卡号"})
        <#--<span title="未知" &lt;#&ndash;style="color: #ff5654"&ndash;&gt;>(*****)</span>-->
        </td>
        <td>
        ${dto.mobile!}
        </td>
        ...
        <td>
            <#if dto.source=="wx">
                微信
            <#elseif dto.source=="pc">
                pc端
            <#elseif dto.source=="xsht">
                线上后台
            <#elseif dto.source=="xxht">
                线下后台
            </#if>
        </td>
        <td>
