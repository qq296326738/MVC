...
<body>
<form class="layui-form" id="inputForm" action="../save/consumption" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input onkeyup="amount1(this)" name="multiple" lay-verify="required|number" autocomplete="off"
                       class="layui-input">
            </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="startTime" name="startTime" placeholder="活动开始时间" lay-verify="required"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="endTime" name="endTime" placeholder="活动结束时间" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
